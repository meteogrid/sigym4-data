...
, dimensional-parsers, hspec, ieee754, newtype, pretty, QuickCheck
, should-not-typecheck, sigym4-dimension, sigym4-geometry
, spatial-reference, stdenv, template-haskell, text, time, vector
}:
mkDerivation {
  pname = "sigym4-data";
  version = "0.1.0.0";
  ...
  libraryHaskellDepends = [
    ...
    deepseq dimensional dimensional-parsers ieee754 newtype pretty
